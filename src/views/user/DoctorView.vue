    ...
    <div>
        ...
        <template>
            <el-table :data="tableData" style="width: 100%">
                <el-table-column label="医生名称" prop="name" width="180" sortable>
                </el-table-column>
                <el-table-column label="特长" prop="specialty" width="500">
                </el-table-column>
                <el-table-column label="职称" prop="position" width="180">
                </el-table-column>
                <el-table-column label="余号" prop="remind" width="180" align="center" sortable>
                </el-table-column>
